...
public class PaymentFailedOutboxScheduler {
    private final JsonUtil jsonUtil;
    private final OutboxRepository outboxRepository;
    private final PaymentEventProducer paymentEventProducer;

    @Scheduled(fixedRate = 2000)
    public void sendPendingPaymentFailedOutbox() {
        List<OutboxMessage> messages = outboxRepository.findByProcessedFalseAndType(GeneralConstants.PAYMENT_FAILED_OUTBOX_TYPE);
